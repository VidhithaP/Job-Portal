            ...
            <div className="flex items-center justify-center max-w-7xl mx-auto">
                ...
                >
                    ...
                    <div className="my-2 ">
                        ...
                        <Input type="text" placeholder="Enter your phone number" value={input.phoneNumber} name="phoneNumber" onChange={changeEventHandler}/>
                    </div>
                    <div className="my-2 ">
                    ...
                    {
                        loading ?<Button className="w-full my-4"><Loader2 className="mr-2 h-4 m-4 animate-spin"/>Please wait </Button>:<Button type="submit" className="w-full my-4">Sign up </Button>
                    }
